...
public class Turret extends SubsystemBase implements Loggable {
  ...
  private static final double ZERO_OFFSET = 18375;

  // 2022 values

  // The Minimum and Maximum rotation ticks of the turret are 120 degrees in both directions
  private static final int MIN_ROTATION_TICKS = -5625; // originally -19188 and 19188
  private static final int MAX_ROTATION_TICKS = 42375; 
  ...
  private static final double ACCELERATION = degreesPerSecondToTicksPer100ms(360 * 0.2);
