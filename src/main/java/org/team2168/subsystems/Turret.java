...
public class Turret extends SubsystemBase implements Loggable {
  ...
  private static final double ACCELERATION = degreesPerSecondToTicksPer100ms(360.0 * 7.5);
  private static final double CRUISE_VELOCITY = degreesPerSecondToTicksPer100ms(360.0 * 5);
