...
public class UpdatePhotonPoseEstimator extends CommandBase {
  ...
  public void execute() {
    ...
    photonVisionCamera.photonPoseEstimator.setLastPose(new Pose3d(photonVisionCamera.getAvgRobotPose().getX(),
    photonVisionCamera.getAvgRobotPose().getY(),
    photonVisionCamera.getAvgRobotPose().getZ(),
    new Rotation3d()));  // use Drivetrain gyro info
    photonVisionCamera.photonPoseEstimator.update();
  }
